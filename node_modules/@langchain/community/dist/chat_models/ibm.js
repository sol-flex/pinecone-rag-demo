...
function _convertToValidToolId(modelId, tool_call_id) {
...
function _convertMessagesToWatsonxMessages(messages, modelId) {
    const getRole = (role) => {
        switch (role) {
            case "human":
                return "user";
...
function _convertDeltaToMessageChunk(delta, rawData, modelId, usage, defaultRole) {
    if (delta.refusal)
...
export class ChatWatsonx extends BaseChatModel {
    ...
    constructor(fields) {
        ...
        Object.defineProperty(this, "top_logprobs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
