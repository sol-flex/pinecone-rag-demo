...
export declare function transformStreamToObjectStream<T>(apiResponse: any): Promise<AsyncIterable<ObjectStreamed<T>>>;
export declare class LineTransformStream extends StreamTransform {
    _transform(chunk: any, _encoding: string, callback: TransformCallback): void;
    _flush(callback: TransformCallback): void;
}
export declare function transformStreamToStringStream<T>(apiResponse: any): Promise<LineTransformStream>;
